...
//  MARK: GHToast
class GHToast: NSObject {
    static public let shared = GHToast()

    private var toastContents: Array<[CanBeToast]> = []
    private var active = false
    private var toastView: GHToastView?
    ...
    override private init () {
        ...
        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(GHToast.keyboardWillAppear(notification:)),
                         name: UIResponder.keyboardWillShowNotification,
                         object: nil)

        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(GHToast.keyboardWillDisappear(notification:)),
                         name: UIResponder.keyboardDidHideNotification,
                         object: nil)

        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(GHToast.orientationWillChange(notification:)),
    ...
    private func showToast() {
        ...
        UIView.setAnimationDidStop(#selector(GHToast.animationStep2))
        toastView?.transform = CGAffineTransform(rotationAngle: degress * .pi / 180.0)
    ...
    @objc private func animationStep2() {
        ...
        UIView.setAnimationDelegate(self)
        UIView.setAnimationDidStop(#selector(GHToast.animationStep3))
...
//  MARK: GHToastView
fileprivate class GHToastView: UIView {
